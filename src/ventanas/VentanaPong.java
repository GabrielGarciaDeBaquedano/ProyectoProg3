...
public class VentanaPong {
	...
	public VentanaPong( int anchura, int altura, String titulo ) {
		setLookAndFeel();
		cerrada = false;
	...
	public void dibujaImagen( String recursoGrafico, double centroX, double centroY, 
		...
		if (ii==null) {
			try {
				ii = new ImageIcon( VentanaPong.class.getResource( recursoGrafico ));
...
public void anyadeBoton( String texto, ActionListener evento ) {
	...
	private static void tiro() {
		...
		private static VentanaPong v;
	/** Método main de prueba de la clase
	 * @param args	No utilizado
	 */
	public static void main(String[] args) {
		v = new VentanaPong( 800, 600, "Test Ventana Gráfica" );
