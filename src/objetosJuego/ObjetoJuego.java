...
public abstract class ObjetoJuego {
		...
		public double x;      // Coordenada x de centro o punto de referencia del objeto 
		public double y;      // Coordenada y de centro o punto de referencia del objeto 
		protected double vX;     // velocidad x de desplazamiento del objeto (en píxels por segundo)
		protected double vY;     // velocidad y de desplazamiento del objeto (en píxels por segundo)
		protected double rot = 0.0;
		
		
		public ObjetoJuego( double x, double y, double rot ) {
			this.x = x;
			this.y = y;
			this.rot = rot;
		}
		...
		public void mueve( double segs ) {
			x = FisicaAsteroids.calcEspacio( x, vX, segs );
			y = FisicaAsteroids.calcEspacio( y, vY, segs );
		}
		
		/** Dibuja el objeto espacial en una ventana
		 * @param v	Ventana en la que dibujar el objeto juego
		 */
